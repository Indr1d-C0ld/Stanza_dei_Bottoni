...
if (array_key_exists('ricomincia', $opz)) {
    ...
    foreach (['sdb_nazione_stato', 'sdb_mondo_stato', 'sdb_relazione', 'sdb_evento',
              'sdb_conoscenza', 'sdb_rapporto', 'sdb_notizia', 'sdb_guerra',
              'sdb_poltrona', 'sdb_fazione', 'sdb_gabinetto', 'sdb_tick_log',
              'sdb_capacita_intel', 'sdb_presenza_intel'] as $t) {
